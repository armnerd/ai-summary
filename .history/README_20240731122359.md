...
### 3.2 ollama
```bash
https://ollama.com/library 其实是一个本地模型的管理软件 里面有很多本地的大模型

安装示例：https://ollama.com/download 

对应模型下载 参考：https://ollama.com/library/llama3 
...
安装说明：https://github.com/ollama/ollama/blob/main/docs/linux.md
